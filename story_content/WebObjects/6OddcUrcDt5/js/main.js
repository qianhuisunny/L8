...
var revisit = false;
revisit = player.GetVar("attempt71");
/////////////////
...
var answerArray1 = new Array("1","2","3","6","7","8");
var answerArray2 = new Array("4","5","10","11");
var answerArray3 = new Array("1","2","3","6","7","8");
var answerArray4 = new Array("4","5","6","7","8","9");
var answerArray5 = new Array("1","2","3","10","11");
var attempt=0;
	           ...
	           for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject1[k] == 1 || dropObject1[k] == 2 || dropObject1[k] == 3 || dropObject1[k] == 6 || dropObject1[k] == 7 || dropObject1[k] == 8)
				...
				for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject2[k] == 4 || dropObject2[k] == 5 || dropObject2[k] == 10 || dropObject2[k] == 11)
				...
				for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject3[k] == 1 || dropObject3[k] == 2 || dropObject3[k] == 3 || dropObject3[k] == 6 || dropObject3[k] == 7 || dropObject3[k] == 8)
				...
				for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject4[k] == 4 || dropObject4[k] == 5 || dropObject4[k] == 6 || dropObject4[k] == 7 || dropObject4[k] == 8 || dropObject4[k] == 9)
				...
				for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject5[k] == 1 || dropObject5[k] == 2 || dropObject5[k] == 3 || dropObject5[k] == 10	 || dropObject5[k] == 11)
