...
var revisit = false;
revisit = player.GetVar("attempt72");
/////////////////
...
var answerArray1 = new Array("1","2","3","4","5","9","10");
var answerArray2 = new Array("3","4","5","8");
var answerArray3 = new Array("6","7");
var answerArray4 = new Array("1","2","3","4","5","6","7","9","10");
	           ...
	           for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject1[k] == 1 || dropObject1[k] == 2 || dropObject1[k] == 3 || dropObject1[k] == 4 || dropObject1[k] == 5 || dropObject1[k] == 9 || dropObject1[k] == 10)
				...
				for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject2[k] == 3 || dropObject2[k] == 4 || dropObject2[k] == 5 || dropObject2[k] == 8)
				...
				for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject3[k] == 6 || dropObject3[k] == 7)
				...
				for(var k=0;k<=7;++k)
				{
					...
					{
						if(dropObject4[k] == 1 || dropObject4[k] == 2 || dropObject4[k] == 3 || dropObject4[k] == 4 || dropObject4[k] == 5 || dropObject4[k] == 6 || dropObject4[k] == 7 || dropObject4[k] == 9 || dropObject4[k] == 10)
